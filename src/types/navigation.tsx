...
class SocialItem {
    ...
    label: string;
    href: string;
    icon: (props: React.HTMLProps<SVGSVGElement>) => JSX.Element;

    constructor(name: string, label: string, href: string, icon: (props: React.HTMLProps<SVGSVGElement>) => JSX.Element) {
        this.name = name;
        this.label = label;
        this.href = href;
        this.icon = icon;
